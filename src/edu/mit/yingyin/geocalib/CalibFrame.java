...
public class CalibFrame extends JFrame implements KeyListener {
  private class ImagePanel extends JPanel implements MouseListener {
    ...
    public void update() {
      ...
      // the container, or layout-related information changed) after the container
      // has been displayed.
      validate();
      repaint();
    }
     ...
     * 
     * @param fileName
     *          path to save the image. If the path is not valid, an error message
     *          is generated
     */
    ...
    public void drawPoints(List<Point> pts) {}
  ...
  public static void createAndShow(GeoCalibModel icm) {
    CalibFrame imf = new CalibFrame(icm);
    imf.pack();
    imf.setVisible(true);
  }
